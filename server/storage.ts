...
export interface IStorage {
  ...
  updateVehicleTracking(trackingData: TrackingData): Promise<Vehicle | undefined>;
...
export class MemStorage implements IStorage {
  ...
  async updateVehicleTracking(trackingData: TrackingData): Promise<Vehicle | undefined> {
    ...
    const updated: Vehicle = {
      ...
      lastUpdate: trackingData.timestamp ?? new Date().toISOString(),
    };

    this.vehicles.set(vehicle.id, updated);
    this.notifyVehicleUpdate();
    return updated;
  }
