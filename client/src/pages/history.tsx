  ...
  return (
    <div className="h-full flex flex-col" data-testid="history-page">
      <div className="p-6 border-b border-border">
        <h1 className="text-2xl font-bold mb-1" data-testid="text-page-title">Histórico de Rotas</h1>
        <p className="text-muted-foreground">Visualize trajetos e eventos dos veículos</p>
      </div>
