...
export default function AlertsPage() {
  ...
  return (
    <div className="h-full flex flex-col" data-testid="alerts-page">
      <div className="p-6 border-b border-border">
        <h1 className="text-2xl font-bold mb-1" data-testid="text-page-title">Alertas e Notificações</h1>
        <p className="text-muted-foreground">Monitore e gerencie alertas e violações da frota</p>
      </div>

      <div className="flex-1 flex min-h-0">
        <div className="w-[280px] flex-shrink-0 border-r border-border bg-sidebar flex flex-col">
          <div className="p-4 border-b border-sidebar-border">
            <h2 className="font-semibold text-lg mb-1">Filtros</h2>
